...
function CampaignDetailList() {
  ...
  const [clientFullNameEng, setClientFullNameEng] = useState("");
  const [clientFullNameChi, setClientFullNameChi] = useState("");
  const [dateOfBirth, setDateOfBirth] = useState("");
  const [firstPolicyIssueDate, setFirstPolicyIssueDate] = useState("");
  const [latestIssuedPolicy, setLatestIssuedPolicy] = useState("");
  const [servAgentCode, setServAgentCode] = useState("");
  const [servAgentName, setServAgentName] = useState("");
  const [trNameEng, setTrNameEng] = useState("");
