  ...
  <div class="bg-white rounded-lg shadow-lg ">
    <div class="px-6 py-4">
      <div class="flex items-center justify-between mb-4">
        <h5 class="text-lg font-semibold text-gray-900" id="exampleModalScrollableTitle">Partner Plus - Terms of Use</h5>
      </div>
      <div class="modal-body h-96 overflow-y-auto">
        ...
        <br/>
        <h6 class="font-semibold text-base leading-relaxed text-gray-500 dark:text-gray-400">
    ...
    <div class="px-6 py-4 bg-gray-100 flex justify-end">
      <button onClick={handleDecline} type="button" class="text-white bg-red-500 hover:bg-red-700 rounded-md px-4 py-2 mr-2 active:bg-white active:text-red-500 active:ring-1 active:ring-red-500 transition" data-dismiss="modal">Not Agree</button>
      <button onClick={handleAccept} type="button" class="text-white bg-ft hover:bg-ft-light rounded-md px-4 py-2 active:bg-white active:text-ft active:ring-1 active:ring-ft transition">Agree</button>
    </div>
  </div>
</div>
</div>
